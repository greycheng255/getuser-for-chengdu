...
# 注意：与 /home/ubuntu/getuser 项目区分，使用不同端口
CDP_DEBUG_PORT = 9322
...
# Linux: 直接使用 Chrome 二进制文件(非wrapper脚本),避免沙箱环境下 /dev/fd/ 权限问题
CUSTOM_BROWSER_PATH = "/home/ubuntu/.cache/ms-playwright/chromium-1124/chrome-linux/chrome"
...
CRAWLER_MAX_COMMENTS_COUNT_SINGLENOTES = 500000
